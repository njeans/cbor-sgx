...
pub mod std_tests {
    ...
    //#[test]
    pub fn integer_canonical_sort_order() {
        let expected = [
            0,
            23,
            24,
    ...
    //#[test]
    pub fn string_canonical_sort_order() {
        let expected = ["", "a", "b", "aa"]
            .into_iter()
    ...
    //#[test]
    pub fn bytes_canonical_sort_order() {
    ...
    //#[test]
    pub fn simple_data_canonical_sort_order() {
    ...
    //#[test]
    pub fn major_type_canonical_sort_order() {
        let expected = vec![
            Value::Integer(0),
            Value::Integer(-1),
            Value::Bytes(vec![]),
